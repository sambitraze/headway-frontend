...
export default function Index({mainRef}) {
        ...
        <>
            <Box
                ...
                sx={{
                    ...
                    background: `url('/backgrounds/dashboardBg6.jpg')`,
                ...
                <Container maxWidth={'lg'}>
                    <Box textAlign={'center'} width={'100%'} >
                        <Box lineHeight={0.6} position={'relative'}>
                            <Box letterSpacing={'8px'} fontWeight={900} fontSize={{md: '130px', xs: '50px'}} sx={{color: 'rgba(255, 255, 255, 0.15)'}}>
                                INNOVANCE
                            </Box>
                            <Box fontWeight={900} fontSize={{md: '90px', xs: '50px'}} color={'#FFF'} position={'absolute'} top={13} width={'100%'} textAlign={'center'} letterSpacing={'2.5px'} zIndex={1}>
                                IoT <span style={{color: '#4763B7'}}>Lab</span>
                            </Box>
                        </Box>
